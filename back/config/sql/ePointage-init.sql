...
VALUES
    (
        ...
        'f',
        40,
        'uploads/pic-1733255955988-964129042.png',
        'data:image/png;base64,',
        '2024-07-26 19:27:42.196082'
    ),
    (
        'LEFORT',
        'LEFORT',
